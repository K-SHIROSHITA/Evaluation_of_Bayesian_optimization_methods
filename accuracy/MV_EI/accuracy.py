...
def main(n, m, dim, noise, bounds):
    ...
    image_name = "./MV_EI/image/val_2D"
    plot_6d(points, val_y, image_name=image_name)

    # 予測平均をplot(2次元だけ取り出してあとは平均値)
    image_name = "./MV_EI/image/pred_y_mean_2D_0"
    ...
    for i in range(10):
        ...
        # 予測平均をplot(2次元だけ取り出してあとは平均値)
        image_name = "./MV_EI/image/pred_y_mean_2D_" + str(i + 1)
        plot_6d(points, pred_y, image_name=image_name)
    ...
    plt.savefig("./MV_EI/image/mse.png")
